...
- Show M3E export compatibility diagnostics for flattened structure, approximate mappings, unresolved transitions, and device-preset normalization; jump to semantic targets or copy the relevant JSON path when no target remains.
...
- Follow outgoing navigation relationships from the screen flow rail, including toolbar, tab bar, Alert, and menu actions, without leaving the canvas.
